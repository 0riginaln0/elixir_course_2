defmodule MapReduce do
      ...
      {:reducer,
       [
         {:reducer,
          [
            {:mapper,
             "/home/ryzh/Downloads/projects/elixir_course_2/lesson_01/01_01_processes.md"},
            {:mapper, "/home/ryzh/Downloads/projects/elixir_course_2/lesson_01/01_02_mailbox.md"},
            {:mapper, "/home/ryzh/Downloads/projects/elixir_course_2/lesson_01/01_03_link.md"}
          ]},
         {:reducer,
          [
            {:mapper, "/home/ryzh/Downloads/projects/elixir_course_2/lesson_01/01_04_monitor.md"},
            {:mapper,
             "/home/ryzh/Downloads/projects/elixir_course_2/lesson_01/01_05_map_reduce.md"}
          ]}
       ]}
  ...
  defmodule Reducer do
    ...
    def run(parent, tree_nodes) do
      IO.puts(
        "Reducer #{inspect(self())} with parent #{inspect(parent)} and #{length(tree_nodes)}"
      )
